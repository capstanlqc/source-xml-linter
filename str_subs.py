...
parser.add_argument(
    "-i", "--input", help="specify path to the folder containing the files to be processed")
parser.add_argument(
    "-o", "--output", help="specify path to the folder where the processed files should be saved")
parser.add_argument(
...
if __name__ == "__main__":
    ...
    for dirpath, dirs, files in os.walk(input_dpath):
        ...
        for fname in files:
            ...
            text = run_substitutions(text, patterns, re.MULTILINE|re.DOTALL) # |re.UNICODE
